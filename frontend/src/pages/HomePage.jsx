...
function displayClinics() {
    return clinics.map((clinic) => (
        <div key={clinic.id} className="bg-white p-4 rounded-xl shadow-md">
            ...
            <div className="mb-2">
                ...
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <span className="text-gray-600"><strong>{clinic.hours}</strong></span>
                </div>
                <p className="text-gray-600 mb-4">{clinic.address}</p>
            </div>
            {/* Always at the bottom */}
            <div className="flex justify-end items-center mt-auto">
                <button className="flex-1 bg-primary text-white px-4 py-2 rounded-xl hover:bg-[#FEA08E] transition">Book Appointment</button>
                <button className="ml-2 border border-gray-300 bg-white text-black px-4 py-2 rounded-xl hover:bg-gray-100 transition">
...
const HomePage = () => {
  return (
    <div className="p-base bg-background min-h-screen">
        {/* Home Header */}
        ...
        <div className="flex space-x-4 mt-8 mb-2">
            <button className="bg-primary text-white px-4 py-2 rounded-full hover:bg-blue-700 transition">Near You</button>
            <button className="bg-background-dark text-black px-4 py-2 rounded-full hover:bg-gray-400 transition">Popular</button>
            <button className="bg-background-dark text-black px-4 py-2 rounded-full hover:bg-gray-400 transition">24/7 Open</button>
        </div>
